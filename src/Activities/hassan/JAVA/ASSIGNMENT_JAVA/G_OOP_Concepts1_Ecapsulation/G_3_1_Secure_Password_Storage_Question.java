...
public class G_3_1_Secure_Password_Storage_Question {
//    Objective: Learn about hiding implementation details from the user.
//
//Steps:
//
//    1. Create a class called LoginSystem.
//    2. Define a private member variable hashedPassword (type String). In a real-world scenario, passwords would be hashed, but for simplicity, we're just using plain text here.
//
